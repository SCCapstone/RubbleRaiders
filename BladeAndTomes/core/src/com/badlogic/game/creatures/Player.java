    ...
    public Player() {
        ...
        playerIcon.addListener(playerInput = new InputListener() {
            ...
            public boolean keyDown(InputEvent event, int keycode)
            {
                switch(keycode) {
                    case Input.Keys.UP:
                        playerIcon.addAction(Actions.moveTo(playerIcon.getX(), playerIcon.getY() + MOVE_DISTANCE,.5f));
                    ...
                    case Input.Keys.LEFT:
                        playerIcon.addAction(Actions.moveTo(playerIcon.getX() - MOVE_DISTANCE, playerIcon.getY(),.5f));
                        playerMovenSound.playMoveSound();
                        break;
